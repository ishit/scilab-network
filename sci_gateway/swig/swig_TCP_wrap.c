...
int _wrap_TcpOpen(SWIG_GatewayParameters) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  int result;
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "TcpOpen" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  result = (int)TcpOpen(arg1);
  SWIG_Scilab_SetOutputPosition(1);
...
int _wrap_client(SWIG_GatewayParameters) {
  char *arg1 = (char *) 0 ;
  int arg2 ;
  int res1 ;
  char *buf1 = 0 ;
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "client" "', argument " "1"" of type '" "char *""'");
  }
  arg1 = (char *)(buf1);
  ecode2 = SWIG_AsVal_int(2, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "client" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
  result = (int)client(arg1,arg2);
  SWIG_Scilab_SetOutputPosition(1);
  if (!SWIG_IsOK(SWIG_Scilab_SetOutput(pvApiCtx, SWIG_From_int((int)(result))))) return SWIG_ERROR;
...
int _wrap_close(SWIG_GatewayParameters) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  int result;
...
extern "C"
#endif
int network_Init(SWIG_GatewayParameters) {
